    ...
    return <div>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex flex-wrap mhn2-ns mb3">
              {(entry.getIn(["data", "values"]) || []).map((value, i) => <div className="ph2-ns w-25-ns cms" key={i}>
                <img src={getAsset(value.get("image"))} alt="" className="center db mb3" style={{maxWidth: "100%", height: "auto"}}/>
                <h6>{value.get("title")}</h6>
                <p>{value.get("text")}</p>
              </div>)}
            </div>
          </div>
